...
- `Демо-набор`: встроенные публикации из `trendwatcher/demo_data.py`; лучший режим для стабильной защиты без сети. Внутри есть международные и русскоязычные материалы: цифровой рубль, СБП, антифрод, биометрический onboarding, BNPL-партнерство, а также русскоязычный шум вроде памятных монет, вакансий и крипто-вебинаров.
...
trendwatcher/demo_data.py       Демо-набор с международными/русскими сигналами, дублями и шумом
...
1. Демо-набор: видно международные и русскоязычные сигналы, шум, дубли и полезные карточки.
